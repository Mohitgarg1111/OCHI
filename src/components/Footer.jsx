        ...
        <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20'>
            ...
            <div className='w-1/2 flex flex-col justify-between h-full'>
                ...
                <div className='heading'>
                    ...
                    <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-5'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
                ...
                <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-5'>Presentations</h1>
